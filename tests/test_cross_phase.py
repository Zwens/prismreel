...
class TestModelSettingsIntegration:
    ...
    def test_series_has_default_model_settings(self):
        ...
        # DashScope 下线后：图像默认 Gemini，视频默认 Seedance。
        assert s.model_settings.t2i_model == "gemini-3.1-flash-image"
        assert s.model_settings.i2v_model == "seedance-2.5-i2v"
    ...
    def test_update_series_model_settings_via_pipeline(self, pipeline):
        ...
        assert updated.model_settings.i2i_model == "gemini-3.1-flash-image"
    ...
    def test_update_series_model_settings_partial_via_copy(self, pipeline):
        ...
        assert updated.model_settings.i2i_model == "gemini-3.1-flash-image"  # preserved
