# PrismReel Unified Model Catalog Phase 1 Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Upgrade PrismReel’s `model_catalog` to a mode-aware, future gateway-ready source schema while preserving all current frontend/backend consumer behavior and stored project compatibility.
...
Pilot the mode-aware source shape on the strongest PrismReel candidate first:
