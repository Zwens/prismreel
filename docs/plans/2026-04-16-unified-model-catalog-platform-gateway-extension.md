...
> Scope: Shared schema extension note before PrismReel implementation  
...
For the next PrismReel implementation generation:
...
## 6. PrismReel-Specific Recommendation

For PrismReel implementation, we should treat Platform/Gateway as:
...
PrismReel phase 1 does **not** need:
...
- Keep current backend routing model for PrismReel phase 1
