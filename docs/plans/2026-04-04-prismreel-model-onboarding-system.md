# PrismReel Model Onboarding System Implementation Plan
...
**Files:**
- Create: `/Users/hoshinoren/Documents/code/project/video_gen/gitlab/tron-comic/.codex/workflows/prismreel-model-onboarding.md`
- Create: `/Users/hoshinoren/Documents/code/project/video_gen/gitlab/tron-comic/.claude/commands/prismreel-model-onboarding.md`
...
- when `/prismreel-model-onboarding` should be used
...
Teach the repo that requests like “接入新模型”, “更新模型文档”, “运行模型接入工作流”, and `/prismreel-model-onboarding` should load the new workflow.
