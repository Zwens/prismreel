...
**已知殘留待辦**：另外3對（6筆，`asset-20260225014832-bdcj7`/`014826-lr75n`、`014910-4hq8j`/`014919-k4dcd`、`015321-rcxrz`/`015258-npckt`）縮圖雜湊也重複，屬於更早批次（120原有或早期補的），暫不確定是ModelArk庫裡真實的「雙胞胎」角色還是同款抓取錯誤，已滾動300+張追查未果，使用者裁決今日先結案，下次用同一套「React fiber滾動」手法接續排查。
