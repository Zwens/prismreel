...
const WS_VIEW_KEY = "prismreel_workspace_view";
...
export default function Home() {
  ...
  const [currentView, setCurrentView] = useState<'home' | 'project' | 'series' | 'series-episode' | 'library' | 'settings' | 'aivideo' | 'playground'>('home');
