        ...
        try {
          ...
          if (s.status === 'completed' || s.status === 'failed') {
            ...
            updateGeneration({
              ...
              outputs: full.outputs.map((o) => ({ id: o.id, media_path: o.media_path, media_type: o.media_type as 'image' | 'video', thumbnail_path: o.thumbnail_path, saved_to_library: o.saved_to_library, total_tokens: o.total_tokens, cost_usd: o.cost_usd })),
              error: full.error,
            });
          }
